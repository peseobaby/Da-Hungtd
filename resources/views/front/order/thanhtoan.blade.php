...
<body>
    ...
    <section class="booking">
        ...
        <form action="{{ route('update.order', $order->id) }}" class="booking--form" method="POST">
            @csrf
            <div class="form--col-left">
                        ...
                        <section class="info">
                            ...
                            <div class="info--content">
                                <div class="form-group">
                                    <label for="name">Chứng minh thư nhân dân</label>

                                    <div>
                                        <input type="text" name="serial_number" class="form-control form-control-lg" placeholder="Nhập số chứng minh , thẻ căn cước của bạn" >
                                    </div>
                                </div>
                                ...
                                <div class="form-group info__row">
                                    ...
                                    <div>
                                        <input type="text" name="phone" class="form-control form-control-lg" placeholder="VD: 0962642655" value="">
                                    </div>
                                </div>
                                ...
                                <div class="form-group info__row">
                                    ...
                                    <div>
                                        <input type="text" name="email" class="form-control form-control-lg" placeholder="VD: abc@viralsoft.vn" value="">
                                    </div>  
                                </div>
                ...
                <div class="btn btn--control">
                    ...
                    <button class="next" type="submit">Tiếp theo</button>
                </div>
            </div>
                        ...
                        <div class="fare--header">
                            <div class="fare__image">
                                <div class="image-width">
                                    <img src="{{ asset($order->room->images->first()->url) }}" alt="">
                                </div>
